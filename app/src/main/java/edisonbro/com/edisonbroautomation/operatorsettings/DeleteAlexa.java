...
public class DeleteAlexa extends Activity implements AdapterView.OnItemSelectedListener,TcpTransfer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delete_alexa);
        ...
        try{
            ...
            WhouseDB=new WirelessConfigurationAdapter(DeleteAlexa.this);
        ...
        Tcp_con mTcp = new Tcp_con(DeleteAlexa.this);
        ...
        if (Tcp_con.isClientStarted) {
            ...
            Tcp_con.stacontxt = DeleteAlexa.this;
            Tcp_con.serverdetailsfetch(this, StaticVariabes_div.housename);
            Tcp_con.registerReceivers(DeleteAlexa.this);
        }
    ...
    public void ReadlineData( final String RL) {
        ...
        if(RL.contains("&011S@"))
        {
            runOnUiThread(new Runnable() {
                public void run() {
                    Toast.makeText(DeleteAlexa.this, "Device Deleted From Gateway Successfully", Toast.LENGTH_SHORT).show();
    ...
    private void popupappdetails(final String txt) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                AlertDialog.Builder alert = new AlertDialog.Builder(DeleteAlexa.this);
                alert.setTitle("Info");
                //alert.setMessage("Enter Password");
                final TextView applnnameinfo = new TextView(DeleteAlexa.this);
    ...
    private void Alert(final String title,final String msg) {
        runOnUiThread(new Runnable() {
            ...
            @Override
            public void run() {
                AlertDialog.Builder dlg = new AlertDialog.Builder(DeleteAlexa.this,AlertDialog.THEME_HOLO_LIGHT);
                dlg.setTitle(title);
                dlg.setMessage(msg);
    ...
    private void FillDeviceList(){
        ...
        try{
           ...
           // devMap=houseDB.getRoomDevices_usrdevnames(CurrentRoomNo);
            devMap=houseDB.getRoomalexa_usrdevnames(CurrentRoomNo,"ALXA");
    ...
    void goPrevious(){
        ...
        Intent it=new Intent(DeleteAlexa.this,Configuration_Main.class);
        startActivity(it);
    ...
    public  void DeleteDeviceLocal(int deviceNo){
        ...
        if(isdeleted){
            ...
            try {
                ...
                locallist_adap = new LocalListArrangeTable(DeleteAlexa.this, StaticVariabes_div.housename,StaticVariabes_div.housename);
                locallist_adap.open();
    ...
    public void Update_db_version_number(){
        if(StaticVariabes_div.housename!=null) {
            try {
                ...
                sdadap = new ServerDetailsAdapter(DeleteAlexa.this);
                sdadap.open();
