...
/**
 *  FILENAME: Curtain_Main_Fragment.java
 *  DATE: 07-08-2018

 *  DESCRIPTION: Main Fragment to operate entire room curtain Devices and
 *  option to switch to group and individuals .

 *  Copyright (C) EdisonBro Smart Labs Pvt Ltd. All rights reserved.
 *
 *  functions:
 *  transmitdata : To transmit curtain n sheer data through tcp.
 ...
 * {@link Curtain_Main_Fragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Curtain_Main_Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Curtain_Main_Fragment extends  android.app.Fragment  implements TcpTransfer,View.OnClickListener {
    ...
    private static final String TAG1="Curt_Main - ";
     ...
     * @return A new instance of fragment Curtain_Main_Fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static Curtain_Main_Fragment newInstance(String param1, String param2) {
        Curtain_Main_Fragment fragment = new Curtain_Main_Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.curtain_main_frag, container, false);
        btn_individuals= (Button) view.findViewById(R.id.btn_curindi);
        ...
        groupexists=mas_adap.fetchUniquegroupids("KEY_ea","CUR", StaticVariabes_div.room_n);
        mas_adap.close();
       ...
       List<String> finlList= new ArrayList<String>();
        ...
        grp_spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> arg0, View arg1,
                                       int arg2, long arg3) {
                Track_button_event("Curtain Main","Group Operation","Curtain Shortclick");
        ...
        btn_individuals.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Track_button_event("Curtain Main","Individual Operation","Curtain Shortclick");

                mas_adap.open();
                devexists=mas_adap.fetchdevnoundergroup("000","CUR", StaticVariabes_div.room_n);
                ...
                StaticVariabes_div.Curtinit(devtotalcnt,devexists,devmodtyp,devnams);
                StaticVariabes_div.typ_G_I="ind";
                combf.SwitchtoDeviceFragment("Cur", "I", devexists[0], StaticVariabes_div.roomname, devmodtyp[0],devnams[0], 0);
        ...
        switch (v.getId()) {
            case R.id.opencurtboth:
                if(b_both_Open!=null) {
                    transmitdata(101);
                    transmitdata(105);
                    Track_button_event("Curtain Main","Open Both","Curtain Shortclick");
            ...
            case R.id.closecurtboth:
                if(b_both_Close!=null) {
                    transmitdata(102);
                    transmitdata(106);
                    Track_button_event("Curtain Main","Close Both","Curtain Shortclick");
            ...
            case R.id.stopcurtboth:
                if(b_both_stop!=null) {
                    transmitdata(103);
                    transmitdata(107);
                    Track_button_event("Curtain Main","Stop Both","Curtain Shortclick");
            ...
            case R.id.opencursheer:
                if(b_sheer_Open!=null) {
                    transmitdata(105);
                    Track_button_event("Curtain Main","Open Sheer","Curtain Shortclick");
                }
            ...
            case R.id.closecursheer:
                if(b_sheer_Close!=null) {
                    transmitdata(106);
                    Track_button_event("Curtain Main", "Close Sheer", "Curtain Shortclick");
                }
                break;
            case R.id.stopcursheer:
                if(b_sheer_stop!=null) {
                    transmitdata(107);
                    Track_button_event("Curtain Main", "Stop Sheer", "Curtain Shortclick");
                }
                    break;
            case R.id.opencurnorm:
                if(b_Open!=null) {
                    transmitdata(101);
                    Track_button_event("Curtain Main", "Open Curtain", "Curtain Shortclick");
                }
                    break;
            case R.id.closecurnorm:
                if(b_Close!=null) {
                    transmitdata(102);
                    Track_button_event("Curtain Main", "Close Curtain", "Curtain Shortclick");
                }
                break;
            case R.id.stopcurnorm:
                if(b_stop!=null) {
                    transmitdata(103);
                    Track_button_event("Curtain Main", "Stop Curtain", "Curtain Shortclick");
                }
                break;
    ...
    public void loaddata(String group,String typdev){
        ...
        if(group!=null){
            ...
            if(typdev.contains("CUR")){
                StaticVariabes_div.Curinit_group(devtotalcnt, grpdevnos,grpmoddevnos,grpdevnams);
            }

            StaticVariabes_div.typ_G_I="grp";
            combf.SwitchtoDeviceSettings("Cur", "G");
            combf.SwitchtoDeviceFragment("Cur", "G", grpdevnos[0], StaticVariabes_div.roomname, grpmoddevnos[0],grpdevnams[0], 0);
    ...
    {  String str,val4;
        ...
        if (Tcp_con.isClientStarted) {
            ...
            str = "0" + "33" + "000" + devno + roomno+val4+"000000000000000";
