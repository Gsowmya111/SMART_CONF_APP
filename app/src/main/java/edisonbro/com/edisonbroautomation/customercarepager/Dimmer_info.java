...
public class Dimmer_info extends AppCompatActivity {
    ...
    public Integer[] imgicon={R.drawable.dimmer_op,R.drawable.group_pir_select,R.drawable.individual_pir_select,R.drawable.settings_icon,R.drawable.timer_settings,R.drawable.fade,R.drawable.smooth,R.drawable.up_arrow01,R.drawable.ebca01,R.drawable.down_arrow01,R.drawable.colorselected,R.drawable.group_pir_select,R.drawable.individual_pir_select};

    public Integer[] imgicon_mood={R.drawable.timer_001,R.drawable.dimmer_op,R.drawable.moodcancel,R.drawable.moodsave};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(p_name.equalsIgnoreCase("EdisonBro Smart Dimmer Controller")||p_name.equalsIgnoreCase("EdisonBro Wireless Smart Dimmer Controller")) {

            setContentView(R.layout.cc_dimmer_controller);

            curtain_controller_img=(ImageView)findViewById(R.id.curtain_controller_img);
            dimmer_controller_popup_img();

        }
        else if(p_name.equalsIgnoreCase("Select Room & Dimmer")) {
            setContentView(R.layout.cc_dimmer_select);

            curtain_select_img=(ImageView)findViewById(R.id.curtain_select_img);
            dimmer_select_popup_img();


        }else if(p_name.equalsIgnoreCase("Perform Operations")) {
            setContentView(R.layout.cc_dimmer_perform_op);
            ...
            dimmer_settimer_popup_img();
        }
        else if(p_name.equalsIgnoreCase("Set Moods")) {
            setContentView(R.layout.cc_dimmer_moodset);
            curtain_table=(TableLayout)findViewById(R.id.curtain_table);
            curtain_table2=(TableLayout)findViewById(R.id.curtain_table2);
            dimmer_moods();
            dimmer_moods_list();
        ...
        if(p_name.equalsIgnoreCase("EdisonBro Smart Dimmer Controller")||p_name.equalsIgnoreCase("EdisonBro Wireless Smart Dimmer Controller")) {
            tv_title.setText("EB Smart Dimmer");
        }else if(p_name.equalsIgnoreCase("Select Room & Dimmer")) {
            tv_title.setText("Select Dimmer");
        }else{
...
//////////////////////////////////////////////////////////////////////////////////////////
    ...
    void dimmer_perform() {
        ...
        int size=tabledata.Dimmer_perform_op.length;
        size--;
        for (int current = 0; current < tabledata.Dimmer_perform_op.length; current++) {
            ...
            t1.setText(tabledata.Dimmer_perform_op[current]);
            t2.setText(tabledata.Dimmer_perform_op_exp[current]);
    ...
    void dimmer_chng_set() {
        ...
        for (int current = 0; current < tabledata.Dimmer_change_setting.length; current++) {
            row = new TableRow(this);
            ...
            t1.setText(tabledata.Dimmer_change_setting[current]);
            t2.setText(tabledata.Dimmer_change_setting_exp[current]);
            ...
            if(tabledata.Dimmer_change_setting[current].equalsIgnoreCase("SET"))
            {
                m1=new ImageView(this);
                m1.setLayoutParams(new TableRow.LayoutParams(60,60));
                m1.setImageResource(R.mipmap.dim_brightness);
                row.addView(m1);
                row.addView(t2);
            }else {
                row.addView(t1);
    ...
    void dimmer_set_timer() {
        ...
        for (int current = 0; current < tabledata.Dimmer_timer.length; current++) {
            row = new TableRow(this);
            ...
            t1.setText(tabledata.Dimmer_timer[current]);
            t2.setText(tabledata.Dimmer_timer_exp[current]);
        ...
        int size=tabledata.Dimmer_timer_list.length;
        size--;
        for (int current = 0; current < tabledata.Dimmer_timer_list.length; current++) {
            ...
            t1.setText(tabledata.Dimmer_timer_list[current]);
            t2.setText(tabledata.Dimmer_timer_list_exp[current]);
    ...
    void dimmer_moods() {
        ...
        int size=tabledata.Dimmer_mood.length;
        size--;
        for (int current = 0; current < tabledata.Dimmer_mood.length; current++) {
            ...
            t1.setText(tabledata.Dimmer_mood[current]);
            t2.setText(tabledata.Dimmer_mood_exp[current]);
    ...
    void dimmer_moods_list() {
        ...
        int size=tabledata.Dimmer_mood_list.length;
        size--;
        for (int current = 0; current < tabledata.Dimmer_mood_list.length; current++) {
            ...
            t1.setText(tabledata.Dimmer_mood_list[current]);
            t2.setText(tabledata.Dimmer_mood_list_exp[current]);
    ...
    // curtain Select  //
    public void dimmer_select_popup_img()
    {
        curtain_select_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                imgr.setImageResource(R.drawable.cc_dimmer_app_select2);
    ...
    public void dimmer_change_setting_popup_img()
    {
        curtain_change_set_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                imgr.setImageResource(R.drawable.dimmer_set_chng);
    ...
    // curtain controller  //
    public void dimmer_controller_popup_img()
    {
        curtain_controller_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                imgr.setImageResource(R.drawable.dimer_controlr);
    ...
    public void dimmer_mood_popup_img()
    {
        curtain_mood_img1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                imgr.setImageResource(R.drawable.dimmer_mood_operation);
    ...
    public void dimmer_perform_popup_img()
    {
        curtain_perform_img1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                imgr.setImageResource(R.drawable.dimmer_group); //curtain_group
        ...
        curtain_perform_img2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                imgr.setImageResource(R.drawable.dimmer_individual); //curtain_individual
    ...
    public void dimmer_settimer_popup_img()
    {
        ...
        curtain_set_timer_img2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                imgr.setImageResource(R.drawable.dimmer_timer_operation);
    ...
    public void dimmer_troubleshoot_popup_img()
    {
