...
public class SwitchBoard_app_operation extends AppCompatActivity {
    ...
    public LinearLayout heading_lay;
    public ProgressDialog progress;
    public PopupWindow popupWindow;

    public Integer[] imgicon={R.drawable.all_off,R.drawable.all_on,R.drawable.all_off,R.drawable.all_on};
    ...
    ImageView imgremote,secondimg,thirdimg;
...
//        actionBar.setDisplayHomeAsUpEnabled(true);
        ...
        tv_title.setText("App Operation");

      /*  if(p_name.equalsIgnoreCase("Select Room & Switchboard")) {
            tv_title.setText("Select Switchboard");
        }else{
        ...
        heading_lay=(LinearLayout) findViewById(R.id.heading_lay) ;
        ...
        imgremote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    imgr.setImageResource(R.drawable.sb_panel1);
                }
                else
        ...
        if(p_name.equalsIgnoreCase("Change icon"))
        {
            ...
            heading_lay.setVisibility(View.GONE);
        ...
        else if(p_name.equalsIgnoreCase("Set Moods"))
        {
            ...
            third2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                   ...
                   // imgr.setImageResource(R.drawable.mood2);
                    imgr.setImageResource(R.drawable.cc_mood2);
            ...
            imageView4.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    imgr.setImageResource(R.drawable.cc_mood3);
        ...
        for (int current = 0; current < tabledata.abbreviations.length; current++) {
           ...
           // t1.setPadding(20 * dip, 0, 0, 0);
            ...
            else if(tabledata.abbreviations[current].equalsIgnoreCase("RESET IR"))
            {
                m1=new ImageView(this);
                m1.setLayoutParams(new TableRow.LayoutParams(50,50));
                m1.setImageResource(R.mipmap.reset_ir);
                row.addView(m1);
                row.addView(t2);
            }
            else if(tabledata.abbreviations[current].equalsIgnoreCase("FAN SPEED"))
            {
                m1=new ImageView(this);
                m1.setLayoutParams(new TableRow.LayoutParams(50,50));
                m1.setImageResource(R.mipmap.fan_speed_icon);
                row.addView(m1);
                row.addView(t2);
            }
            else
